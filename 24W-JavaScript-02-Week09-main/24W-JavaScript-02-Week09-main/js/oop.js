...
function createHamburger(options) {
    ...
    // Construct hamburger object
    const hamburger = {
        bun: hamburgerOptions.bun,
        garnish: hamburgerOptions.garnish,
        cheese: hamburgerOptions.cheese,
        sauce: hamburgerOptions.sauce,
        patty: hamburgerOptions.patty,
        pattyCount: hamburgerOptions.pattyCount,
        additionalToppings: hamburgerOptions.additionalToppings
    };
...
const myHamburger = createHamburger({
    ...
    patty: 'chicken',
    pattyCount: 2,
    additionalToppings: ['pickles', 'hot peppers']
});
